...
public class ReactorActionManager extends AbstractPlayerInteraction {
    ...
    private String name;
    private int ch = World.Find.findChannel(name);
    ...
    public ReactorActionManager(MapleClient c, MapleReactor reactor) {
        ...
        if (c.getPlayer() != null) {
            c.getPlayer().setReactorNow(reactor.getReactorId());
        }
    }
    ...
    private void spawnFakeMonster(int id, int qty, Point pos) {
        if (getPlayer() != null && MapleLifeFactory.getMonster(id) == null) {
            FileoutputUtil.logToFile_ReactorScript_Bug(getPlayer(), " 含有 怪物代碼[" + id + "] 不存在 之漏洞\r\n");
