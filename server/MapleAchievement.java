...
public class MapleAchievement {
    ...
    /* private String name;
     ...
     if (notice && !chr.isGM()) {
     World.Broadcast.broadcastMessage(MaplePacketCreator.getItemNotice("[Achievement] Congratulations to " + chr.getName() + " on " + name + " and rewarded with " + reward + " A-cash!").getBytes());
     } else {
     chr.getClient().sendPacket(MaplePacketCreator.getErrorNotice("[Achievement] You've gained " + reward + " A-cash as you " + name + "."));
     }
     }*/
}
