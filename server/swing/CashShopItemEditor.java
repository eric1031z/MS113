 ...
 * @author pungin
 */
public class CashShopItemEditor extends javax.swing.JFrame implements UIWindow {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        WvsCenter.getInstance().updateCashShopItem(new Object[]{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashShopItemEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
