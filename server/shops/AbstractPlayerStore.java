...
public abstract class AbstractPlayerStore extends AbstractMapleMapObject implements IMaplePlayerShop {
    ...
    protected HashMap<Integer, Triple<String, Long, Long>> visitors = new HashMap<>();
    ...
    public void addVisitor(MapleCharacter visitor) {
        ...
        if (i > 0) {
            ...
            if (!isOwner(visitor)) {
                visitors.put(visitor.getId(), new Triple(visitor.getName(), System.currentTimeMillis(), -1));
            }
            if (i == 3) {
                update();
            }
    ...
    public void removeVisitor(MapleCharacter visitor) {
        ...
        if (slot > 0) {
            ...
            if (!isOwner(visitor)) {
                visitors.put(visitor.getId(), new Triple(visitor.getName(), visitors.get(visitor.getId()).getMid(), System.currentTimeMillis()));
            }
        }
    }
