...
public class SpawnPoint extends Spawns {
    ...
    public SpawnPoint(final MapleMonster monster, final Pair<Integer, Point> pos, final int mobTime, final byte carnivalTeam, final String msg) {
