...
public class MapleLifeFactory {
    ...
    public static final void loadQuestCounts(boolean reload) {
        if (reload) {
            questCount.clear();
        }
    ...
    public static MapleMonster getMonster(int mid) {
        ...
        if (stats == null) {
            ...
            stats.setUndead(MapleDataTool.getIntConvert("undead", monsterInfoData, 0) > 0 || mid == 9700004 || mid == 9700009 || mid == 9700010 || mid == 9700011);
