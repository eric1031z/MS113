...
public class MapleDoor extends AbstractMapleMapObject {
    ...
    public final void sendSpawnData(final MapleClient client) {
        ...
        if (target.getId() == client.getPlayer().getMapId() || (getOwnerId() == client.getPlayer().getId() && getOwner().getParty() == null)) {
    ...
    public final void sendDestroyData(final MapleClient client) {
        if (getOwner() == null || client == null || target == null || client.getPlayer() == null) {
            return;
        }
