...
function action(mode, type, selection) {
    ...
    case 0:
              if (mode == 1) {
           if (cm.getBossLog("熊獅王次數") >= 2&& !cm.haveItem(4009324,1)&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                cm.sendNext("很抱歉每天只能打兩次..");
                cm.dispose();
                return;
            }
			if (cm.getBossLog("熊獅王次數") >= 3&& cm.haveItem(4009324,1)&& !cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                cm.sendNext("很抱歉VIP通行證一天只能打3次");
                cm.dispose();
                return;
            }
			if (cm.getBossLog("熊獅王次數") >= 4&& cm.haveItem(4009325,1) && !cm.haveItem(4009326,1)) {
                cm.sendNext("很抱歉VVIP通行證一天只能打4次");
                cm.dispose();
                return;
            }
			if (cm.getBossLog("熊獅王次數") >= 5&& cm.haveItem(4009326,1)) {
    ...
    case 3:
        if (mode == 1) {
            var squd = cm.getSquad("ScarTar");
            if (squd != null && !squd.getAllNextPlayer().contains(cm.getPlayer().getName())&&!cm.haveItem(4009324,1)&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
		...
		if (squd != null && !squd.getAllNextPlayer().contains(cm.getPlayer().getName())&&cm.haveItem(4009324,1)&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                if (cm.getBossLog("熊獅王次數") == 3) {
                    cm.sendOk("很抱歉VIP通行證每天只能打3次");
                    cm.dispose();
                    return;
                }
				if (cm.getBossLog("熊獅王次數") < 3 ){
		...
		if (squd != null && !squd.getAllNextPlayer().contains(cm.getPlayer().getName())&&cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                if (cm.getBossLog("熊獅王次數") == 4) {
                    cm.sendOk("很抱歉VVIP通行證每天只能打4次");
                    cm.dispose();
                    return;
                }
				if (cm.getBossLog("熊獅王次數") < 4 ){
		...
		if (squd != null && !squd.getAllNextPlayer().contains(cm.getPlayer().getName())&&cm.haveItem(4009326,1)) {
                if (cm.getBossLog("熊獅王次數") == 5) {
                    cm.sendOk("很抱歉VVVIP通行證每天只能打5次");
                    cm.dispose();
                    return;
                }
				if (cm.getBossLog("熊獅王次數") < 5 ){
    ...
    case 5:
        if (selection == 0) { // join
            ...
            if (ba == 2) {
                cm.sendOk("遠征隊員已經達到30名，請稍後再試。");
            } else if (ba == 1 && !cm.getPlayer().isGM()&&cm.getBossLog("熊獅王次數") < yaoshi&&!cm.haveItem(4009324,1)&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                if (cm.getBossLog("熊獅王次數") == yaoshi) {
                    cm.sendOk("很抱歉每天只能打兩次..");
                    cm.dispose();
                    return;
                ...
                cm.sendOk("啊你現在是想偷打?");
				cm.dispose();
            } else if (ba == 1 && !cm.getPlayer().isGM()&&cm.getBossLog("熊獅王次數") >=3&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                cm.sendOk("啊你現在是想偷打?");
				cm.dispose();
            } else if (ba == 1 && !cm.getPlayer().isGM()&&cm.getBossLog("熊獅王次數") >=4&&!cm.haveItem(4009326,1)) {
                cm.sendOk("啊你現在是想偷打?");
				cm.dispose();
            } else if (ba == 1 && !cm.getPlayer().isGM()&&cm.getBossLog("熊獅王次數") >=5) {
                cm.sendOk("啊你現在是想偷打?");
				cm.dispose();
            } else if (ba == 1 && !cm.getPlayer().isGM()&&cm.getBossLog("熊獅王次數") >= yaoshi&&cm.haveItem(4009324,1)&&!cm.haveItem(4009325,1)&&!cm.haveItem(4009326,1)) {
                if (cm.getBossLog("熊獅王次數") == 3) {
