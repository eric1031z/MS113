...
function start() {
    cm.sendNext("嗨 我是 #b#p9000011##k. 我在等待我的哥哥 #b保羅#k. 他應該現在在這裡...");
}
    ...
    if (mode == -1) {
        ...
        if (status == 1) {
            ...
            if (selection == 0) {
                ...
                cm.sendSimple("有許多活動規則。這將幫助在你開始活動之前。好了...選擇你想了解的活動.. #b\r\n#L0# 爬繩子#l\r\n#L1# 終極忍耐#l\r\n#L2# 滾雪球#l\r\n#L3# 打果子#l\r\n#L6# 打瓶蓋#l\r\n#L4# 是非題大考驗#l\r\n#L5# 尋寶#l\r\n#L7# 你的生死#l#k");
            } else if (selection == 2) {
            ...
            if (selection == 0) {
				...
				cm.sendNext("#b[你的生死]#k 自己#e#rGoogle#k!");
			}
			cm.dispose();
        }
    }
