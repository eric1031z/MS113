...
function allMonstersDead(eim) {
	...
	map.broadcastMessage(tools.MaplePacketCreator.broadcastMessage(6, "[The Boss Quest] Congratulations! Your team has defeated all the bosses with " + points + " points!"));
	map.broadcastMessage(tools.MaplePacketCreator.broadcastMessage(6, "[The Boss Quest] The points have been awarded, spend them as you wish."));
	disbandParty();
    } else {
	map.broadcastMessage(tools.MaplePacketCreator.broadcastMessage(6, "[The Boss Quest] Your team now has " + points + " points! The next boss will spawn in 10 seconds."));
...
function beginQuest(eim) {
    var map = eim.getMapInstance(mapid, 0);
    map.broadcastMessage(tools.MaplePacketCreator.broadcastMessage(6, "[The Boss Quest] The creatures of the darkness are coming in 30 seconds. Prepare for the worst!"));
