...
function scheduleNew() {
    ...
    KC_docked.broadcastMessage(MaplePacketCreator.broadcastMessage(6, "地鐵列車到站了。"));
    NLC_docked.broadcastMessage(MaplePacketCreator.broadcastMessage(6, "地鐵列車到站了。"));
...
function takeoff() {
    ...
    KC_docked.broadcastMessage(MaplePacketCreator.broadcastMessage(6, "地鐵列車已經離開了."));
    NLC_docked.broadcastMessage(MaplePacketCreator.broadcastMessage(6, "地鐵列車已經離開了."));
