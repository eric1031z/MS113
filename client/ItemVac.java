...
public class ItemVac extends Thread {
    ...
    public synchronized void run() {
        try {
            while (!interrupted()) {
                this.wait(5000); // 每次全圖吸秒數 5000毫秒=5秒
            ...
            //e.printStackTrace();
            //FileoutputUtil.logToFile("logs/ItemVac.txt", "\r\n[tempBan] " + FileoutputUtil.NowTime() + "  " + chr.getName() + "/" + chr.getMapId() + "未知錯誤" + e);
            //System.err.println("[ItemVac] "  + chr.getName() + "/" + chr.getMapId() + "未知錯誤" + e);
        }
    }
}
