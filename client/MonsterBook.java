...
public class MonsterBook implements Serializable {
   ...
   public boolean isMasterInCards(int monsterId){
       final MapleMonsterInformationProvider mi = MapleMonsterInformationProvider.getInstance();
       return getLevelByCard(mi.getMonsterCardByMonster(monsterId)) == 5;       
   }
    ...
    public final void addCard(final MapleClient c, final int cardid) {
        ...
        if (cards.containsKey(cardid)) {
            ...
            if (levels >= 5) {
                //c.getPlayer().dropMessage(6,"您已完成此怪物的怪物卡收集，對此怪物掉落率增加1.5倍，經驗增加1.3倍") 秋田無加成;   
