...
public class BuddyEntry {
     ...
     */
    public BuddyEntry(String name, int characterId, String group, int channel, boolean visible) {
        super();
        this.name = name;
    ...
    public BuddyEntry(long id, String name, int characterId, String group, int channel, boolean visible) {
        super();
        this.id = id;
