            ...
            while (OnlyId.hasNext()) {
                ...
                if (ch < 0 && ch != -10 && ch != -20) {
                    try {
                        ...
                        FileoutputUtil.logToFile("logs/hack/複製裝備_已刪除.txt", FileoutputUtil.CurrentReadable_Time() + " " + msgtext + " 道具: [" + itemname + "] 辨識為一ID: " + equiponlyid + "\r\n");
                    } catch (SQLException ex) {
                    ...
                    MapleInventoryManipulator.removeAllByEquipByInventoryId(chrs.getClient(), invetoryitemid);
                }
            }
            clearData();
        } catch (Exception ex) {
