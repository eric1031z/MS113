...
//        mplew.writeShort(c.getJob());
    ...
    public static final byte[] MerchantVisitorView(final HashMap<Integer, Triple<String, Long, Long>> visitor) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        Iterator<Triple<String, Long, Long>> msgs = visitor.values().iterator();
        while (msgs.hasNext()) {
            Triple<String, Long, Long> msg = msgs.next();
            String chrname = msg.getLeft();
            long lefttime = (((msg.getRight() - msg.getMid()) / 1000) / 60);
            if (lefttime > 76) {
                lefttime += 7;
            } else if (lefttime > 65) {
                lefttime += 6;
            ...
            mplew.writeShort(0);
            mplew.writeShort((int) (lefttime > 32767 ? 32767 : lefttime));
        }
