...
//        closeAllMerchant();
    ...
    public final int getExpRate() {
        return WorldConstants.EXP_RATE * extend_Exp;
    }
    ...
    public final int getMesoRate() {
        return WorldConstants.MESO_RATE * extend_Meso;
    }
    ...
    public final int getDropRate() {
        return WorldConstants.DROP_RATE * extend_Drop;
    }
