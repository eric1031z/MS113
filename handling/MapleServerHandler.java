        ...
        switch (header) {
            ...
            case CHECK_CHAR_NAME:
                try {
                    ...
                    FilePrinter.printError("CharLoginHandler.txt", ex, " checkCharName has Exception, Packet: " + slea.toString());
                }
                break;
            case CREATE_CHAR:
            ...
            case SET_GENDER:
                try {
                    ...
                    FilePrinter.printError("CharLoginHandler.txt", ex, " SetGenderRequest has Exception, Packet: " + slea.toString());
                }
                break;
            // END OF LOGIN SERVER
            case CHANGE_CHANNEL:
            ...
            case ENTER_CASH_SHOP:
                //InterServerHandler.EnterCashShop(c, c.getPlayer(), false, c.getPlayer().getCSType());
                if (c.getPlayer().inMapleLand() || c.getPlayer().inMarket()) {
                    c.getSession().writeAndFlush(tools.MaplePacketCreator.enableActions());
                    c.getPlayer().dropMessage(5, "在新手村莊、活動地圖、自由市場內部(不含入口)無法使用拍賣。");
                } else {
                    c.getSession().writeAndFlush(tools.MaplePacketCreator.enableActions());
                    NPCScriptManager.getInstance().start(c, 9010000, "商城");
                }
                break;
            case ENTER_MTS:
                if (c.getPlayer().inMapleLand() || c.getPlayer().inMarket()) {
            ...
            case CHANGE_MAP_SPECIAL:
                try {
                    ...
                    FilePrinter.printError("PlayerHandler.txt", ex, " ChangeMapSpecial has Exception, Packet: " + slea.toString());
                }
                break;
            case USE_INNER_PORTAL:
                try {
                    ...
                    FilePrinter.printError("PlayerHandler.txt", ex, " InnerPortal has Exception, Packet: " + slea.toString());
                }
                break;
            case TROCK_ADD_MAP:
            ...
            case CP_UserOldAntiMacroQuestionResult:
                PlayersHandler.OldAntiMacroQuestion(slea, c, c.getPlayer());
                break;
            case ARAN_COMBO:
            ...
            case TRANSFORM_PLAYER:
                try {
                    ...
                    FilePrinter.printError("PlayersHandler.txt", ex, " TransformPlayer has Exception, Packet: " + slea.toString());
                }
                break;
            case NOTE_ACTION:
...
//                c.getPlayer().updateTick(slea.readInt());
            ...
            case NPC_TALK:
                ...
                break;
            case CP_HiredMerchantRemoteControl:
                PlayerInteractionHandler.HiredMerchantRemoteControl(slea, c, c.getPlayer());
                break;
            case NPC_TALK_MORE:
            ...
            case NPC_ACTION:
                ...
                break;
            case STORAGE:
                NPCHandler.handleStorage(slea, c, c.getPlayer());
                break;
            case GENERAL_CHAT:
                try {
                    ChatHandler.GeneralChat(slea.readMapleAsciiString(), slea.readByte(), c, c.getPlayer());
                } catch (Exception ex) {
                    FilePrinter.printError("ChatHandler.txt", ex, " 角色說話有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case PARTYCHAT:
            ...
            case PET_CHAT:
                ...
                short chatSize = slea.readShort();
                if (slea.available() < chatSize) {
                    System.err.println("收到未處理寵物說話包");
                    break;
                }
                try {
                    PetHandler.PetChat(petid, command, slea.readAsciiString(chatSize), c.getPlayer());
                } catch (Exception ex) {
                    FilePrinter.printError("PetHandler.txt", ex, " PetChat has Exception, Packet: " + slea.toString());
                }
                break;
            case PET_COMMAND:
            ...
            case REQUEST_FAMILY:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 訪問家族有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case OPEN_FAMILY:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 開啟家族有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case FAMILY_OPERATION:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 家族操作有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case DELETE_JUNIOR:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 家族DeleteJunior有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case DELETE_SENIOR:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 家族DeleteSenior有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case USE_FAMILY:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 使用家族有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case FAMILY_PRECEPT:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 家族Precept有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case FAMILY_SUMMON:
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 家族召喚有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
            case ACCEPT_FAMILY:
                if (slea.available() < 5) {
                ...
                try {
                    ...
                    FilePrinter.printError("FamilyHandler.txt", ex, " 接受家族有異常,Packet訊息: \r\n" + slea.toString());
                }
                break;
